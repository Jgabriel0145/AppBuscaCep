...
namespace AppBuscaCep.Services
{
    public class DataService
    {
        ...
        public static async Task<List<Bairro>> GetBairroByIdCidade(string id_cidade)
        {
            List<Bairro> arr_bairros = new List<Bairro>();

            using (HttpClient client = new HttpClient())
            {
                HttpResponseMessage response = await client.GetAsync("https://cep.metoda.com.br/bairro/by-cidade?id_cidade=" + int.Parse(id_cidade));
